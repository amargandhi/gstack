...
version: 2.0.0
description: |
  Use when the user is brainstorming a new idea, exploring problem-solution fit,
  or wants to stress-test an approach before building. Triggers on: 'office hours',
  'brainstorm', 'should I build this', 'idea validation', 'startup idea'.
allowed-tools:
  - Bash
  - Read
  - Grep
