...
version: 1.0.0
description: |
  Use when the user needs to import browser cookies for authenticated testing —
  imports from Chrome, Arc, Brave, Edge, or Comet. Triggers on: 'import cookies',
  'setup cookies', 'browser cookies', 'authenticate browser', 'login to site'.
allowed-tools:
  - Bash
  - Read
  - AskUserQuestion
