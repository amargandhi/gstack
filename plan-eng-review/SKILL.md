...
version: 1.0.0
description: |
  Use when the user wants engineering feedback on a plan — architecture review,
  data flow analysis, test strategy, and implementation risk assessment. Triggers
  on: 'eng review', 'architecture review', 'review my plan technically',
