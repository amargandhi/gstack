...
version: 1.0.0
description: |
  Use when the user wants a second opinion or adversarial code review from OpenAI
  Codex CLI — runs independently for fresh-eyes analysis. Triggers on: 'codex review',
  'second opinion', 'adversarial review', 'get another perspective'.
allowed-tools:
  - Bash
  - Read
  - Write
