...
version: 1.0.0
description: |
  Use when the user wants a QA report without any code changes — report-only bug
  testing. Triggers on: 'qa report', 'just test', 'find bugs but don\'t fix',
  'qa-only', 'test without fixing'.
allowed-tools:
  - Bash
  - Read
  - Write
