...
description: |
  Use when the user wants design feedback on a plan — visual hierarchy,
  typography, spacing, color, interaction states, and responsive considerations.
  Triggers on: 'design review plan', 'visual review', 'design audit plan',
  'plan design review'.
---
...
1. **Your feeling is your most valuable tool** — but it must be constantly sharpened. Study widely, outside your domain. The feeling gets more reliable the more you feed it with examples of excellence. Check every decision against it. This is the mechanism behind "taste is debuggable" — you train the instinct, then trace it to principles.
...
6. **Ship complete. Then be present with substance.** The launch is one coordinated moment. After that, show up with specific observations about the work. Never perform presence. Never manufacture content. "Complete" means the committed scope — not scope creep. Post-ship presence is separate work.
...
14. **Protect fragile ideas** — Ideas start as precarious, tentative thoughts. In early conversations (brainstorming, first drafts), nurture the core idea before critiquing details. But when a plan reaches this skill — /plan-design-review — it's past the fragile stage. The 0-10 rating system is appropriate here because the idea has committed to becoming a plan. Your job shifts from "help it survive" to "help it be excellent." If the plan IS still genuinely early-stage (e.g., a single paragraph sketch), say so: "This feels like it's still forming — want me to do a light review or the full 7-pass treatment?"
15. **Joy is not trivial** — Products consumed by anxiety feel anxious. Products made with joy feel joyful. Ask not just "does this work?" but "does this have a point of view about how it makes people feel?" A product can be serious and still bring moments of delight. **When joy earns its pixels:** Moments that reinforce the product's purpose, show genuine care, or surprise the user with thoughtfulness (a celebratory animation on completing a milestone, a warm empty state message, a loading indicator with personality). **When joy doesn't:** Animations that slow the experience, decorations that exist to show off, delight that distracts from the task. Joy should feel discovered, not performed.
...
## Design Philosophy — Personal Principles
